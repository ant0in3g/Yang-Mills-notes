...
\renewcommand*{\backrefalt}[4]{
 \ifcase #1 \mapolicebackref{no quotes}
 \or \mapolicebackref{quoted on page #2}
 \else \mapolicebackref{#1 quotations pages #2}
\fi
} % Pour gérer les backref dans la bibliographie.

% BEGIN --------------------  Alphabet math cal.  -------------------- END %
...
% BEGIN --------------------  Alphabet math black board.  -------------------- END %
...
\newcommand{\goV}{\mathfrak{V}}	\newcommand{\goW}{\mathfrak{W}}	\newcommand{\goX}{\mathfrak{X}}
\newcommand{\goY}{\mathfrak{Y}}	\newcommand{\goZ}{\mathfrak{Z}}

% BEGIN --------------------  Alphabet grecque.  -------------------- END %
...
\title{Review of Gauge Theories} % Titre.
\author[$\dag$,$\star$,$\clubsuit$,1,2]{Antoine Géré \vspace{2mm}} % Auteur.
\affil[$\dag$]{Aix-Marseille University, Master of Mathematics and Theoretical Physics \vspace{1mm}} % Affiliation[1].
\affil[$\star$]{Paris Sud 11 University, CNRS, Laboratory of Theoretical Physics, UMR 8627 \vspace{1mm}} % Affiliation[2].
\affil[$\clubsuit$]{University of Genoa, Department of Mathematics\vspace{2mm}} % Affiliation[3].
\affil[1]{\texttt{\href{antoine.gere@etumel.univmed.fr}{antoine.gere@etumel.univmed.fr}}\vspace{1mm}} % Email[1].
\affil[2]{\texttt{\href{gere@dima.unige.it}{gere@dima.unige.it}}} % Email[2].      
\date{\version} % Date.
...
%\begin{figure}
 %\includegraphics[scale=0.5]{diagramme.pdf}
%\end{figure}
